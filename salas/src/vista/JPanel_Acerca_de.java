 ...
 * @author maximiliano
 */
public class JPanel_Acerca_de extends javax.swing.JPanel implements Panels{
    private javax.swing.JTextArea informacionJTextArea;
    
    public JPanel_Acerca_de(){
        initComponents();
        construir();
    }
    ...
    private void construir(){
        ...
        add(jScrollPane, new GBConstraints(0, 0, 1, 1, 1.0, 1.0, GridBagConstraints.CENTER, GridBagConstraints.BOTH, new java.awt.Insets(5, 5, 5, 5), 0, 0));
    }
