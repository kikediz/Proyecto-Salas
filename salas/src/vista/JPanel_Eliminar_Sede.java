 ...
 * @author maximiliano
 */
public class JPanel_Eliminar_Sede extends JPanel implements Panels{
    ...
    private void construir(){
        ...
        add(eliminar_JButton, new GBConstraints(0, 6, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER, 0, new java.awt.Insets(32, 27, 36, 26), 0, 0));
