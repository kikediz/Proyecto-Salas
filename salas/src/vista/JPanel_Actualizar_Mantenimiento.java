 ...
 * @author morte
 */
public class JPanel_Actualizar_Mantenimiento extends JPanel implements Panels{
    ...
    public JPanel_Actualizar_Mantenimiento(){
        initComponents();
        construir();
    }
    ...
    private void construir(){
        ...
        add(actualizar_JButton, new GBConstraints(0, 2, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER, 0, new java.awt.Insets(32, 27, 36, 26), 0, 0));
