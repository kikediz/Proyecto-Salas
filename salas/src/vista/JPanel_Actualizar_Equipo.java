...
public class JPanel_Actualizar_Equipo extends JPanel implements Panels{
    ...
    public JPanel_Actualizar_Equipo(){
        initComponents();
        construir();
    }
    ...
    private void initComponents(){
        ...
        actualizar_JButton = new JButton();
    ...
    private void construir(){
        ...
        add(actualizar_JButton, new GBConstraints(0, 5, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER, 0, new java.awt.Insets(0, 0, 0, 0), 0, 0));
