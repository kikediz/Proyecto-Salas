 ...
 * @author morte
 */
public class JPanel_Actualizar_Mantenimiento_a_Equipo extends JPanel implements Panels{
    ...
    public JPanel_Actualizar_Mantenimiento_a_Equipo(){
        initComponents();
        construir();
    }
    ...
    private void construir(){
        ...
        actualizar_JButton.setIcon(new javax.swing.ImageIcon(getClass().getResource("/vista/agregar.png"))); // NOI18N
        actualizar_JButton.setText("Registrar");
        ...
        add(actualizar_JButton, new GBConstraints(0, 1, 2, 1, 0.0, 0.0, GridBagConstraints.CENTER, 0, new java.awt.Insets(32, 27, 36, 26), 0, 0));
