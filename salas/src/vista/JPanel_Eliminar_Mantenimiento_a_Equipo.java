 ...
 * @author morte
 */
public class JPanel_Eliminar_Mantenimiento_a_Equipo extends JPanel implements Panels{
    ...
    public JPanel_Eliminar_Mantenimiento_a_Equipo(){
        initComponents();
        construir();
    }
    ...
    private void construir(){
        ...
        eliminar_JButton.setIcon(new javax.swing.ImageIcon(getClass().getResource("/vista/agregar.png"))); // NOI18N
        eliminar_JButton.setText("Registrar");
        ...
        add(eliminar_JButton, new GBConstraints(0, 1, 2, 1, 0.0, 0.0, GridBagConstraints.CENTER, 0, new java.awt.Insets(32, 27, 36, 26), 0, 0));
