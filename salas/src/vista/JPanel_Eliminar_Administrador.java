 ...
 * @author maximiliano
 */
public class JPanel_Eliminar_Administrador extends JPanel implements Panels{
    ...
    public JPanel_Eliminar_Administrador(){
        initComponents();
        construir();
    }
    ...
    private void construir(){
        ...
        add(eliminar_JButton, new GBConstraints(1, 4, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER, 0, new java.awt.Insets(0, 0, 0, 0), 0, 0));
